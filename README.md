<h1 align="center">Hi 👋 I'm Harvey (Chunghao Tuan)</h1>
...
- 🎓 CS Master's Student @ **Oregon State University** (Graduating June 2025)
- 💼 Former **Software QA Engineer** @ Shopee (Asia's leading e-commerce platform)
- ⚙️ Skilled in backend development, API testing, system automation, and AI integration
- 🌍 Open to **Full-time Software Engineer / Backend / QA** roles (Remote or On-site, 2025 start)
...
Python, C/C++, JavaScript/TypeScript, Django, Flask, Node.js, Express.js, React.js  

**Tools & Platforms:**  
Git, Docker, GitHub, Jenkins, Selenium, Appium, Postman, AWS, Linux CLI, Jira, Agile  

**Development Focus:**  
RESTful API Design, Full-stack Web Dev, Test Automation, Webhook Integration, AI Tools, GitHub API
...
| 🤖 **AI Code Watcher** | AI-powered code review system that auto-comments on GitHub PRs via webhook & GitHub API integration | FastAPI, React, Docker, ngrok | [Repo](https://github.com/harveytuan23/AI-Code-Watcher) |
